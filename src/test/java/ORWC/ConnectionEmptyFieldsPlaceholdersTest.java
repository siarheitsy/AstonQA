...
public class ConnectionEmptyFieldsPlaceholdersTest extends BaseTest {
    ...
    @Description("Test Description: test for correct display of the Phone number, Sum and Email placeholders for 'Connection' option")
    @Story("Check empty fields values of 'Connection' option in online replenishment block")
    public static void connectionEmptyFieldsPlaceholdersTest() {
        ...
        Allure.step("Connection option selected in ORWC block");
