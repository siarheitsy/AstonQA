...
public class BepaidAppCardLogosPresence extends BaseTest {
    ...
    @Test(groups = {"functional"}, description = "Check for payment system logos in BepaidApp card input", priority = -1)
    @Description("Test Description: test of the correct display of payment system logos in the card input")
    @Story("Check for payment system logos in BepaidApp card input")
